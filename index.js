...
document.getElementById('h3tag').style.textTransform = "uppercase"
document.getElementById('h3tag2').style.textTransform = "uppercase"
document.getElementById('h3tag').style.color = 'green'
document.getElementById('h3tag2').style.color = 'green'
